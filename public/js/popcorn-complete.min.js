...
h=Object.prototype,f=e.forEach,n=e.slice,u=h.hasOwnProperty,q=h.toString,v=m.Popcorn,w=[],o=false,z={events:{hash:{},apis:{}}},J=function(){return m.requestAnimationFrame||m.webkitRequestAnimationFrame||m.mozRequestAnimationFrame||m.oRequestAnimationFrame||m.msRequestAnimationFrame||function(a){m.setTimeout(a,16)}}(),E={put:function(a){for(var c in a)if(a.hasOwnProperty(c))this[c]=a[c]}},g=function(a,c){return new g.p.init(a,c||null)};g.version="51dc389";g.isSupported=true;g.instances=[];g.p=g.prototype=
...
g.forEach({listen:"on",unlisten:"off",trigger:"emit",exec:"cue"},function(a,c){var l=g.p[c];g.p[c]=function(){if(typeof console!=="undefined"&&console.warn){console.warn("Deprecated method '"+c+"', "+(a==null?"do not use.":"use '"+a+"' instead."));g.p[c]=l}return g.p[a].apply(this,[].slice.call(arguments))}});m.Popcorn=g}else{m.Popcorn={isSupported:false};for(e="byId forEach extend effects error guid sizeOf isArray nop position disable enable destroyaddTrackEvent removeTrackEvent getTrackEvents getTrackEvent getLastTrackEventId timeUpdate plugin removePlugin compose effect xhr getJSONP getScript".split(/\s+/);e.length;)m.Popcorn[e.shift()]=
function(){}}})(window,window.document);(function(m){document.addEventListener("DOMContentLoaded",function(){var i=document.querySelectorAll("[data-timeline-sources]");m.forEach(i,function(k,d){var b=i[d],e,h,f;if(!b.id)b.id=m.guid("__popcorn");if(b.nodeType&&b.nodeType===1){f=m("#"+b.id);e=(b.getAttribute("data-timeline-sources")||"").split(",");e[0]&&m.forEach(e,function(n){h=n.split("!");if(h.length===1){h=n.match(/(.*)[\/\\]([^\/\\]+\.\w+)$/)[2].split(".");h[0]="parse"+h[1].toUpperCase();h[1]=n}e[0]&&f[h[0]]&&f[h[0]](h[1])});f.autoplay()&&
f.play()}})},false)})(Popcorn);(function(m,i){function k(e){e=typeof e==="string"?e:[e.language,e.region].join("-");var h=e.split("-");return{iso6391:e,language:h[0]||"",region:h[1]||""}}var d=m.navigator,b=k(d.userLanguage||d.language);i.locale={get:function(){return b},set:function(e){b=k(e);i.locale.broadcast();return b},broadcast:function(e){var h=i.instances,f=h.length,n=0,u;for(e=e||"locale:changed";n<f;n++){u=h[n];e in u.data.events&&u.trigger(e)}}}})(this,this.Popcorn);(function(m){var i=function(k,d){k=k||m.nop;d=d||m.nop;return function(){k.apply(this,arguments);d.apply(this,arguments)}};m.player=function(k,d){if(!m[k]){d=d||{};var b=function(e,h,f){f=f||{};var n=new Date/1E3,u=n,q=0,v=0,w=1,o=false,z={},J=typeof e==="string"?m.dom.find(e):e,E={};Object.prototype.__defineGetter__||(E=J||document.createElement("div"));for(var g in J)if(!(g in E))if(typeof J[g]==="object")E[g]=J[g];else if(typeof J[g]==="function")E[g]=function(A){return"length"in J[A]&&!J[A].call?
...
O){z[A]||(z[A]=[]);z[A].push(O);return O};E.removeEventListener=function(A,O){var a,c=z[A];if(c){for(a=z[A].length-1;a>=0;a--)O===c[a]&&c.splice(a,1);return O}};E.dispatchEvent=function(A){var O,a=A.type;if(!a){a=A;if(A=m.events.getInterface(a)){O=document.createEvent(A);O.initEvent(a,true,true,window,1)}}if(z[a])for(A=z[a].length-1;A>=0;A--)z[a][A].call(this,O,this)};E.src=h||"";E.duration=0;E.paused=true;E.ended=0;f&&f.events&&m.forEach(f.events,function(A,O){E.addEventListener(O,A,false)});if(d._canPlayType(J.nodeName,
h)!==false)if(d._setup)d._setup.call(E,f);else{E.readyState=4;E.dispatchEvent("loadedmetadata");E.dispatchEvent("loadeddata");E.dispatchEvent("canplaythrough")}else setTimeout(function(){E.dispatchEvent("error")},0);e=new m.p.init(E,f);if(d._teardown)e.destroy=i(e.destroy,function(){d._teardown.call(E,f)});return e};b.canPlayType=d._canPlayType=d._canPlayType||m.nop;m[k]=m.player.registry[k]=b}};m.player.registry={};m.player.defineProperty=Object.defineProperty||function(k,d,b){k.__defineGetter__(d,
b.get||m.nop);k.__defineSetter__(d,b.set||m.nop)};m.player.playerQueue=function(){var k=[],d=false;return{next:function(){d=false;k.shift();k[0]&&k[0]()},add:function(b){k.push(function(){d=true;b&&b()});!d&&k[0]()}}};m.smart=function(k,d,b){var e=typeof k==="string"?m.dom.find(k):k,h,f,n,u,q,v="HTMLYouTubeVideoElement HTMLVimeoVideoElement HTMLSoundCloudAudioElement HTMLNullVideoElement".split(" ");if(e){d=typeof d==="string"?[d]:d;k=0;for(q=d.length;k<q;k++){h=d[k];for(f=0;f<v.length;f++)if((u=
m[v[f]])&&u._canPlaySrc(h)==="probably"){n=u(e);b=m(n,b);setTimeout(function(){n.src=h},0);return b}for(var w in m.player.registry)if(m.player.registry.hasOwnProperty(w))if(m.player.registry[w].canPlayType(e.nodeName,h))return m[w](e,h,b)}var o;w=m.guid("popcorn-video-");f=document.createElement("div");f.style.width="100%";f.style.height="100%";if(d.length===1){o=document.createElement("video");o.id=w;e.appendChild(o);setTimeout(function(){var z=document.createElement("div");z.innerHTML=d[0];o.src=
z.firstChild.nodeValue},0);return m("#"+w,b)}e.appendChild(f);v='<video id="'+w+'" preload=auto autobuffer>';k=0;for(q=d.length;k<q;k++)v+='<source src="'+d[k]+'">';v+="</video>";f.innerHTML=v;b&&b.events&&b.events.error&&e.addEventListener("error",b.events.error,false);return m("#"+w,b)}else m.error("Specified target `"+k+"` was not found.")}})(Popcorn);(function(m){var i=Object.prototype.hasOwnProperty;m.parsers={};m.parser=function(k,d,b){if(m.protect.natives.indexOf(k.toLowerCase())>=0)m.error("'"+k+"' is a protected function name");else{if(typeof d==="function"&&!b){b=d;d=""}if(!(typeof b!=="function"||typeof d!=="string")){var e={};e[k]=function(h,f,n){if(!h)return this;if(typeof f!=="function"&&!n){n=f;f=null}var u=this;m.xhr({url:h,dataType:d,success:function(q){var v,w,o=0;q=b(q,n).data||[];if(v=q.length){for(;o<v;o++){w=q[o];for(var z in w)i.call(w,
z)&&u[z]&&u[z](w[z])}f&&f()}}});return this};m.extend(m.p,e);return e}}}})(Popcorn);(function(m,i){function k(b){var e=k.options;b=e.parser[e.strictMode?"strict":"loose"].exec(b);for(var h={},f=14;f--;)h[e.key[f]]=b[f]||"";h[e.q.name]={};h[e.key[12]].replace(e.q.parser,function(n,u,q){if(u)h[e.q.name][u]=q});return h}k.options={strictMode:false,key:["source","protocol","authority","userInfo","user","password","host","port","relative","path","directory","file","query","anchor"],q:{name:"queryKey",parser:/(?:^|&)([^&=]*)=?([^&]*)/g},parser:{strict:/^(?:([^:\/?#]+):)?(?:\/\/((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?))?((((?:[^?#\/]*\/)*)([^?#]*))(?:\?([^#]*))?(?:#(.*))?)/,
loose:/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/}};var d={length:0,start:m.nop,end:m.nop};window.MediaError=window.MediaError||function(){function b(e,h){this.code=e||null;this.message=h||""}b.MEDIA_ERR_NONE_ACTIVE=0;b.MEDIA_ERR_ABORTED=1;b.MEDIA_ERR_NETWORK=2;b.MEDIA_ERR_DECODE=3;b.MEDIA_ERR_NONE_SUPPORTED=4;return b}();m._MediaElementProto=function(){var b=
{},e;Object.prototype.__defineGetter__||(b=i.createElement("div"));b._util={type:"HTML5",TIMEUPDATE_MS:250,MIN_WIDTH:300,MIN_HEIGHT:150,isAttributeSet:function(h){return typeof h==="string"||h===true},parseUri:k};b.addEventListener=function(h,f,n){i.addEventListener(this._eventNamespace+h,f,n)};b.removeEventListener=function(h,f,n){i.removeEventListener(this._eventNamespace+h,f,n)};b.dispatchEvent=function(h){h=new CustomEvent(this._eventNamespace+h,{detail:{type:h,target:this.parentNode,data:null},
bubbles:true,cancelable:false});i.dispatchEvent(h)};b.load=m.nop;b.canPlayType=function(){return""};b.getBoundingClientRect=function(){return e.getBoundingClientRect()};b.NETWORK_EMPTY=0;b.NETWORK_IDLE=1;b.NETWORK_LOADING=2;b.NETWORK_NO_SOURCE=3;b.HAVE_NOTHING=0;b.HAVE_METADATA=1;b.HAVE_CURRENT_DATA=2;b.HAVE_FUTURE_DATA=3;b.HAVE_ENOUGH_DATA=4;Object.defineProperties(b,{currentSrc:{get:function(){return this.src!==undefined?this.src:""},configurable:true},parentNode:{get:function(){return e},set:function(h){e=
h},configurable:true},preload:{get:function(){return"auto"},set:m.nop,configurable:true},controls:{get:function(){return true},set:m.nop,configurable:true},poster:{get:function(){return""},set:m.nop,configurable:true},crossorigin:{get:function(){return""},configurable:true},played:{get:function(){return d},configurable:true},seekable:{get:function(){return d},configurable:true},buffered:{get:function(){return d},configurable:true},defaultMuted:{get:function(){return false},configurable:true},defaultPlaybackRate:{get:function(){return 1},
configurable:true},style:{get:function(){return this.parentNode.style},configurable:true},id:{get:function(){return this.parentNode.id},configurable:true}});return b}})(Popcorn,window.document);(function(m,i,k){function d(){var z;if(YT.loaded)for(v=true;o.length;){z=o.shift();z()}else setTimeout(d,250)}function b(){var z;if(!w){if(i.YT)d();else{z=k.createElement("script");z.addEventListener("load",d,false);z.src="https://www.youtube.com/iframe_api";k.head.appendChild(z)}w=true}return v}function e(z){o.push(z)}function h(z){function J(H){W.push(H)}function E(){Q.pauseVideo();j("play",E);l("play",K)}function g(){l("pause",N);j("pause",g)}function G(){var H=function(){if(Q.isMuted()){l("play",
...
var t=new m._MediaElementProto,y=typeof v==="string"?m.dom.find(v):v,D=k.createElement("iframe"),r={src:f,networkState:t.NETWORK_EMPTY,readyState:t.HAVE_NOTHING,seeking:false,autoplay:f,preload:f,controls:false,loop:false,poster:f,volume:1,muted:0,currentTime:0,duration:NaN,ended:false,paused:true,width:y.width|0?y.width:t._util.MIN_WIDTH,height:y.height|0?y.height:t._util.MIN_HEIGHT,error:null},M=false,x=true,p,B=[],R,K,N=0;t._eventNamespace=m.guid("HTMLSoundCloudAudioElement::");t.parentNode=y;
...
0?r.muted:r.volume},set:function(C){if(C<0||C>1)throw"Volume value must be between 0.0 and 1.0";l(C)}},muted:{get:function(){return r.muted>0},set:function(C){j(t._util.isAttributeSet(C))}},error:{get:function(){return r.error}},controls:{get:function(){return r.controls},set:function(C){s(!!C)}}});t._canPlaySrc=m.HTMLSoundCloudAudioElement._canPlaySrc;t.canPlayType=m.HTMLSoundCloudAudioElement.canPlayType;return t}var h=16,f="",n=false,u=false,q=[];m.HTMLSoundCloudAudioElement=function(v){return new e(v)};
m.HTMLSoundCloudAudioElement._canPlaySrc=function(v){return/(?:https?:\/\/www\.|https?:\/\/|www\.|\.|^)(soundcloud)/.test(v)?"probably":f};m.HTMLSoundCloudAudioElement.canPlayType=function(v){return v==="audio/x-soundcloud"?"probably":f}})(Popcorn,window,document);(function(m,i){function k(h){this.startTime=0;this.currentTime=h.currentTime||0;this.duration=h.duration||NaN;this.playInterval=null;this.paused=true;this.playbackRate=this.defaultPlaybackRate=1;this.ended=h.endedCallback||m.nop}function d(h){function f(a){A.push(a)}function n(){if(!E)return 0;return g.currentTime}function u(a){if(a!==n())if(E){G.seeking=true;o.dispatchEvent("seeking");g.seekTo(a);G.ended=false;G.seeking=false;o.dispatchEvent("timeupdate");o.dispatchEvent("seeked");o.dispatchEvent("canplay");
o.dispatchEvent("canplaythrough")}else f(function(){u(a)})}function q(){o.dispatchEvent("timeupdate")}function v(){G.paused=true;clearInterval(O);o.dispatchEvent("pause")}function w(){if(G.loop){u(0);o.play()}else{G.ended=true;v();o.dispatchEvent("timeupdate");o.dispatchEvent("ended")}}var o=new m._MediaElementProto,z=typeof h==="string"?i.querySelector(h):h,J=i.createElement("div"),E=false,g,G={src:b,networkState:o.NETWORK_EMPTY,readyState:o.HAVE_NOTHING,autoplay:b,preload:b,controls:b,loop:false,
...
setInterval(q,o._util.TIMEUPDATE_MS)}}else f(function(){o.play()})};o.pause=function(){if(E){g.pause();G.paused||v()}else f(function(){o.pause()})};Object.defineProperties(o,{src:{get:function(){return G.src},set:function(a){if(a&&a!==G.src)if(o._canPlaySrc(a)){G.src=a;if(E)if(E&&g){g.pause();g=null;z.removeChild(J);J=i.createElement("div")}J.width=G.width;J.height=G.height;z.appendChild(J);a=e.exec(a);g=new k({currentTime:+a[1],duration:+a[2],endedCallback:w});o.dispatchEvent("loadstart");o.dispatchEvent("progress");
...
a;o.dispatchEvent("ratechange")}},error:{get:function(){return G.error}}});o._canPlaySrc=m.HTMLNullVideoElement._canPlaySrc;o.canPlayType=m.HTMLNullVideoElement.canPlayType;return o}var b="",e=/#t=(\d+\.?\d*)?,?(\d+\.?\d*)/;k.prototype={play:function(){var h=this;if(this.paused){this.paused=false;this.startTime=Date.now();this.playInterval=setInterval(function(){h.currentTime+=(Date.now()-h.startTime)/(1E3/h.playbackRate);h.startTime=Date.now();if(h.currentTime>=h.duration){h.pause(h.duration);h.ended()}h.currentTime<
0&&h.pause(0)},16)}},pause:function(){if(!this.paused){this.paused=true;clearInterval(this.playInterval)}},seekTo:function(h){h=h<0?0:h;this.currentTime=h=h>this.duration?this.duration:h}};m.HTMLNullVideoElement=function(h){return new d(h)};m.HTMLNullVideoElement._canPlaySrc=function(h){return e.test(h)?"probably":b};m.HTMLNullVideoElement.canPlayType=function(h){return h==="video/x-nullvideo"?"probably":b}})(Popcorn,document);(function(m,i){function k(){return"maybe"}function d(b,e){var h=typeof b==="string"?i.querySelector(b):b,f=i.createElement(e);h.appendChild(f);f._canPlaySrc=k;return f}m.HTMLVideoElement=function(b){return d(b,"video")};m.HTMLVideoElement._canPlaySrc=k;m.HTMLAudioElement=function(b){return d(b,"audio")};m.HTMLAudioElement._canPlaySrc=k})(Popcorn,window.document);(function(m,i,k){function d(n){var u=this,q=n.src.split("?")[0];if(q.substr(0,2)==="//")q=i.location.protocol+q;"play pause paused seekTo unload getCurrentTime getDuration getVideoEmbedCode getVideoHeight getVideoWidth getVideoUrl getColor setColor setLoop getVolume setVolume addEventListener".split(" ").forEach(function(v){u[v]=function(w){w=JSON.stringify({method:v,value:w});n.contentWindow&&n.contentWindow.postMessage(w,q)}})}function b(n){function u(x){y.unshift(x)}function q(x){var p=c.duration;
...
var p=x.queryKey,B,R=["api=1","player_id="+j,"title=0","byline=0","portrait=0"];c.loop=p.loop==="1"||c.loop;delete p.loop;c.autoplay=p.autoplay==="1"||c.autoplay;delete p.autoplay;x=f+"/video/"+/\d+$/.exec(x.path)+"?";for(B in p)p.hasOwnProperty(B)&&R.push(encodeURIComponent(B)+"="+encodeURIComponent(p[B]));x+=R.join("&");a.id=j;a.style.width="100%";a.style.height="100%";a.frameBorder=0;a.webkitAllowFullScreen=true;a.mozAllowFullScreen=true;a.allowFullScreen=true;O.appendChild(a);a.src=x;i.addEventListener("message",
...
"//");i._iframe=document.createElement("iframe");i._iframe.setAttribute("width","100%");i._iframe.setAttribute("height","100%");i._iframe.id=i.id;i._iframe.src=i.src;i._iframe.style.display="none";k&&k.appendChild(i._iframe)},start:function(i,k){k._iframe.src=k.src;k._iframe.style.display="inline"},end:function(i,k){k._iframe.style.display="none"},_teardown:function(i){document.getElementById(i.target)&&document.getElementById(i.target).removeChild(i._iframe)}})})(Popcorn);(function(m){function i(b){return String(b).replace(/&(?!\w+;)|[<>"']/g,function(e){return d[e]||e})}function k(b,e){var h=b.container=document.createElement("div"),f=h.style,n=b.media,u=function(){var q=b.position();f.fontSize="18px";f.width=n.offsetWidth+"px";f.top=q.top+n.offsetHeight-h.offsetHeight-40+"px";f.left=q.left+"px";setTimeout(u,10)};h.id=e||"";f.position="absolute";f.color="white";f.textShadow="black 2px 2px 6px";f.fontWeight="bold";f.textAlign="center";u();b.media.parentNode.appendChild(h);
return h}var d={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};m.plugin("text",{manifest:{about:{name:"Popcorn Text Plugin",version:"0.1",author:"@humphd"},options:{start:{elem:"input",type:"number",label:"Start"},end:{elem:"input",type:"number",label:"End"},text:{elem:"input",type:"text",label:"Text","default":"Popcorn.js"},escape:{elem:"input",type:"checkbox",label:"Escape"},multiline:{elem:"input",type:"checkbox",label:"Multiline"}}},_setup:function(b){var e,h,f=b._container=document.createElement("div");
f.style.display="none";if(b.target)if(e=m.dom.find(b.target)){if(["VIDEO","AUDIO"].indexOf(e.nodeName)>-1)e=k(this,b.target+"-overlay")}else e=k(this,b.target);else e=this.container?this.container:k(this);b._target=e;h=b.escape?i(b.text):b.text;h=b.multiline?h.replace(/\r?\n/gm,"<br>"):h;f.innerHTML=h||"";e.appendChild(f);b.toString=function(){return b.text||b._natives.manifest.options.text["default"]}},start:function(b,e){e._container.style.display="inline"},end:function(b,e){e._container.style.display=
"none"},_teardown:function(b){var e=b._target;e&&e.removeChild(b._container)}})})(Popcorn);(function(m){var i=0;m.plugin("flickr",function(k){var d,b=document.getElementById(k.target),e,h,f,n,u=k.numberofimages||4,q=k.height||"50px",v=k.width||"50px",w=k.padding||"5px",o=k.border||"0px";d=document.createElement("div");d.id="flickr"+i;d.style.width="100%";d.style.height="100%";d.style.display="none";i++;b&&b.appendChild(d);var z=function(){if(e)setTimeout(function(){z()},5);else{h="http://api.flickr.com/services/rest/?method=flickr.people.findByUsername&";h+="username="+k.username+"&api_key="+
k.apikey+"&format=json&jsoncallback=flickr";m.getJSONP(h,function(E){e=E.user.nsid;J()})}},J=function(){h="http://api.flickr.com/services/feeds/photos_public.gne?";if(e)h+="id="+e+"&";if(k.tags)h+="tags="+k.tags+"&";h+="lang=en-us&format=json&jsoncallback=flickr";m.xhr.getJSONP(h,function(E){var g=document.createElement("div");g.innerHTML="<p style='padding:"+w+";'>"+E.title+"<p/>";m.forEach(E.items,function(G,A){if(A<u){f=document.createElement("a");f.setAttribute("href",G.link);f.setAttribute("target",
"_blank");n=document.createElement("img");n.setAttribute("src",G.media.m);n.setAttribute("height",q);n.setAttribute("width",v);n.setAttribute("style","border:"+o+";padding:"+w);f.appendChild(n);g.appendChild(f)}else return false});d.appendChild(g)})};if(k.username&&k.apikey)z();else{e=k.userid;J()}k.toString=function(){return k.tags||k.username||"Flickr"};return{start:function(){d.style.display="inline"},end:function(){d.style.display="none"},_teardown:function(E){document.getElementById(E.target)&&
...
label:"API Key",optional:true},target:"flickr-container",height:{elem:"input",type:"text",label:"Height","default":"50px",optional:true},width:{elem:"input",type:"text",label:"Width","default":"50px",optional:true},padding:{elem:"input",type:"text",label:"Padding",optional:true},border:{elem:"input",type:"text",label:"Border","default":"5px",optional:true},numberofimages:{elem:"input",type:"number","default":4,label:"Number of Images"}}})})(Popcorn);var googleCallback;
(function(m){function i(f,n,u){f=f.type?f.type.toUpperCase():"HYBRID";var q;if(f==="STAMEN-WATERCOLOR"||f==="STAMEN-TERRAIN"||f==="STAMEN-TONER")q=f.replace("STAMEN-","").toLowerCase();u=new google.maps.Map(u,{mapTypeId:q?q:google.maps.MapTypeId[f],mapTypeControlOptions:{mapTypeIds:[]}});q&&u.mapTypes.set(q,new google.maps.StamenMapType(q));u.getDiv().style.display="none";return u}var k=1,d=false,b=false,e,h;googleCallback=function(f){if(typeof google!=="undefined"&&google.maps&&google.maps.Geocoder&&
google.maps.LatLng){e=new google.maps.Geocoder;m.getScript("//maps.stamen.com/js/tile.stamen.js",function(){b=true})}else setTimeout(function(){googleCallback(f)},1)};h=function(){if(document.body){d=true;m.getScript("//maps.google.com/maps/api/js?sensor=false&callback=googleCallback")}else setTimeout(function(){h()},1)};m.plugin("googlemap",function(f){var n,u,q,v=document.getElementById(f.target);f.type=f.type||"ROADMAP";f.zoom=f.zoom||1;f.lat=f.lat||0;f.lng=f.lng||0;d||h();n=document.createElement("div");
n.id="actualmap"+k;n.style.width=f.width||"100%";n.style.height=f.height?f.height:v&&v.clientHeight?v.clientHeight+"px":"100%";k++;v&&v.appendChild(n);var w=function(){if(b){if(n)if(f.location)e.geocode({address:f.location},function(o,z){if(n&&z===google.maps.GeocoderStatus.OK){f.lat=o[0].geometry.location.lat();f.lng=o[0].geometry.location.lng();q=new google.maps.LatLng(f.lat,f.lng);u=i(f,q,n)}});else{q=new google.maps.LatLng(f.lat,f.lng);u=i(f,q,n)}}else setTimeout(function(){w()},5)};w();f.toString=
function(){return f.location||(f.lat&&f.lng?f.lat+", "+f.lng:f._natives.manifest.options.location["default"])};return{start:function(o,z){var J=this,E,g=function(){if(u){z._map=u;u.getDiv().style.display="block";google.maps.event.trigger(u,"resize");u.setCenter(q);if(z.zoom&&typeof z.zoom!=="number")z.zoom=+z.zoom;u.setZoom(z.zoom);if(z.heading&&typeof z.heading!=="number")z.heading=+z.heading;if(z.pitch&&typeof z.pitch!=="number")z.pitch=+z.pitch;if(z.type==="STREETVIEW"){u.setStreetView(E=new google.maps.StreetViewPanorama(n,
...
type:"text",label:"Lat",optional:true},lng:{elem:"input",type:"text",label:"Lng",optional:true},location:{elem:"input",type:"text",label:"Location","default":"Toronto, Ontario, Canada"},heading:{elem:"input",type:"text",label:"Heading","default":0,optional:true},pitch:{elem:"input",type:"text",label:"Pitch","default":1,optional:true}}})})(Popcorn);(function(m){var i={},k=0,d=document.createElement("span"),b=["webkit","Moz","ms","O",""],e=["Transform","TransitionDuration","TransitionTimingFunction"],h={},f;document.getElementsByTagName("head")[0].appendChild(d);for(var n=0,u=e.length;n<u;n++)for(var q=0,v=b.length;q<v;q++){f=b[q]+e[n];if(f in d.style){h[e[n].toLowerCase()]=f;break}}document.getElementsByTagName("head")[0].appendChild(d);m.plugin("wordriver",{manifest:{about:{name:"Popcorn WordRiver Plugin"},options:{start:{elem:"input",type:"number",
...
w.word.parentNode&&w._container.removeChild(w.word);i[w.target]&&!i[w.target].childElementCount&&o&&o.removeChild(i[w.target])&&delete i[w.target]}})})(Popcorn);var wikiCallback;
...
delete i.target}}})})(Popcorn);(function(m){var i=0,k=function(d,b){var e=d.container=document.createElement("div"),h=e.style,f=d.media,n=function(){var u=d.position();h.fontSize="18px";h.width=f.offsetWidth+"px";h.top=u.top+f.offsetHeight-e.offsetHeight-40+"px";h.left=u.left+"px";setTimeout(n,10)};e.id=b||m.guid();h.position="absolute";h.color="white";h.textShadow="black 2px 2px 6px";h.fontWeight="bold";h.textAlign="center";n();d.media.parentNode.appendChild(e);return e};m.plugin("subtitle",{manifest:{about:{name:"Popcorn Subtitle Plugin",
...
k(this,d.target):this.container;document.getElementById(d.container.id)&&document.getElementById(d.container.id).appendChild(b);d.innerContainer=b;d.showSubtitle=function(){d.innerContainer.innerHTML=d.text||""}},start:function(d,b){b.innerContainer.style.display="inline";b.showSubtitle(b,b.text)},end:function(d,b){b.innerContainer.style.display="none";b.innerContainer.innerHTML=""},_teardown:function(d){d.container.removeChild(d.innerContainer)}})})(Popcorn);(function(m){m.plugin("mustache",function(i){var k,d,b,e;m.getScript("http://mustache.github.com/extras/mustache.js");var h=!!i.dynamic,f=typeof i.template,n=typeof i.data,u=document.getElementById(i.target);i.container=u||document.createElement("div");if(f==="function")if(h)b=i.template;else e=i.template(i);else e=f==="string"?i.template:"";if(n==="function")if(h)k=i.data;else d=i.data(i);else d=n==="string"?JSON.parse(i.data):n==="object"?i.data:"";return{start:function(q,v){var w=function(){if(window.Mustache){if(k)d=
k(v);if(b)e=b(v);var o=Mustache.to_html(e,d).replace(/^\s*/mg,"");v.container.innerHTML=o}else setTimeout(function(){w()},10)};w()},end:function(q,v){v.container.innerHTML=""},_teardown:function(){k=d=b=e=null}}},{about:{name:"Popcorn Mustache Plugin",version:"0.1",author:"David Humphrey (@humphd)",website:"http://vocamus.net/dave"},options:{start:{elem:"input",type:"number",label:"Start"},end:{elem:"input",type:"number",label:"End"},target:"mustache-container",template:{elem:"input",type:"text",
label:"Template"},data:{elem:"input",type:"text",label:"Data"},dynamic:{elem:"input",type:"checkbox",label:"Dynamic","default":true}}})})(Popcorn);(function(m){var i=1;m.plugin("timeline",function(k){var d=document.getElementById(k.target),b=document.createElement("div"),e,h=true;if(d&&!d.firstChild){d.appendChild(e=document.createElement("div"));e.style.width="inherit";e.style.height="inherit";e.style.overflow="auto"}else e=d.firstChild;b.style.display="none";b.id="timelineDiv"+i;k.direction=k.direction||"up";if(k.direction.toLowerCase()==="down")h=false;if(d&&e)h?e.insertBefore(b,e.firstChild):e.appendChild(b);i++;b.innerHTML="<p><span id='big' style='font-size:24px; line-height: 130%;' >"+
k.title+"</span><br /><span id='mid' style='font-size: 16px;'>"+k.text+"</span><br />"+k.innerHTML;return{start:function(f,n){b.style.display="block";if(n.direction==="down")e.scrollTop=e.scrollHeight},end:function(){b.style.display="none"},_teardown:function(){e&&b&&e.removeChild(b)&&!e.firstChild&&d.removeChild(e)}}},{about:{name:"Popcorn Timeline Plugin",version:"0.1",author:"David Seifried @dcseifried",website:"dseifried.wordpress.com"},options:{start:{elem:"input",type:"number",label:"Start"},
...
start:function(i,k){k._container.style.display="inline"},end:function(i,k){k._container.style.display="none"},_teardown:function(i){var k=m.dom.find(i.target);k&&k.removeChild(i._container)}})})(Popcorn);(function(m){function i(b){function e(){var u=b.getBoundingClientRect(),q=f.getBoundingClientRect();if(q.left!==u.left)f.style.left=u.left+"px";if(q.top!==u.top)f.style.top=u.top+"px"}var h=-1,f=document.createElement("div"),n=getComputedStyle(b).zIndex;f.setAttribute("data-popcorn-helper-container",true);f.style.position="absolute";f.style.zIndex=isNaN(n)?k:n+1;document.body.appendChild(f);return{element:f,start:function(){h=setInterval(e,d)},stop:function(){clearInterval(h);h=-1},destroy:function(){document.body.removeChild(f);
...
e.addEventListener("load",function(){e.style.borderStyle="none";b.anchor.href=b.href||b.src||"#";b.anchor.target="_blank";var f,n;e.style.height=h.style.height;e.style.width=h.style.width;b.anchor.appendChild(e);if(b.text){f=e.height/12+"px";n=document.createElement("div");m.extend(n.style,{color:"black",fontSize:f,fontWeight:"bold",position:"relative",textAlign:"center",width:e.style.width||e.width+"px",zIndex:"10"});n.innerHTML=b.text||"";n.style.top=(e.style.height.replace("px","")||e.height)/
2-n.offsetHeight/2+"px";b.anchor.insertBefore(n,e)}},false);e.src=b.src;b.toString=function(){var f=b.src||b._natives.manifest.options.src["default"],n=f.replace(/.*\//g,"");return n.length?n:f}},start:function(b,e){e.anchor.style.display="inline";e.trackedContainer&&e.trackedContainer.start()},end:function(b,e){e.anchor.style.display="none";e.trackedContainer&&e.trackedContainer.stop()},_teardown:function(b){if(b.trackedContainer)b.trackedContainer.destroy();else b.anchor.parentNode&&b.anchor.parentNode.removeChild(b.anchor)}})})(Popcorn);(function(m){m.plugin("code",function(i){var k=false,d=this,b=function(){var e=function(h){return function(f,n){var u=function(){k&&f.call(d,n);k&&h(u)};u()}};return window.webkitRequestAnimationFrame?e(window.webkitRequestAnimationFrame):window.mozRequestAnimationFrame?e(window.mozRequestAnimationFrame):e(function(h){window.setTimeout(h,16)})}();if(!i.onStart||typeof i.onStart!=="function")i.onStart=m.nop;if(i.onEnd&&typeof i.onEnd!=="function")i.onEnd=undefined;if(i.onFrame&&typeof i.onFrame!==
"function")i.onFrame=undefined;return{start:function(e,h){h.onStart.call(d,h);if(h.onFrame){k=true;b(h.onFrame,h)}},end:function(e,h){if(h.onFrame)k=false;h.onEnd&&h.onEnd.call(d,h)}}},{about:{name:"Popcorn Code Plugin",version:"0.1",author:"David Humphrey (@humphd)",website:"http://vocamus.net/dave"},options:{start:{elem:"input",type:"number",label:"Start"},end:{elem:"input",type:"number",label:"End"},onStart:{elem:"input",type:"function",label:"onStart"},onFrame:{elem:"input",type:"function",label:"onFrame",
optional:true},onEnd:{elem:"input",type:"function",label:"onEnd"}}})})(Popcorn);(function(m){var i=1,k=false;m.plugin("googlefeed",function(d){var b=function(){var n=false,u=0,q=document.getElementsByTagName("link"),v=q.length,w=document.head||document.getElementsByTagName("head")[0],o=document.createElement("link");if(window.GFdynamicFeedControl)k=true;else m.getScript("//www.google.com/uds/solutions/dynamicfeed/gfdynamicfeedcontrol.js",function(){k=true});for(;u<v;u++)if(q[u].href==="//www.google.com/uds/solutions/dynamicfeed/gfdynamicfeedcontrol.css")n=true;if(!n){o.type=
"text/css";o.rel="stylesheet";o.href="//www.google.com/uds/solutions/dynamicfeed/gfdynamicfeedcontrol.css";w.insertBefore(o,w.firstChild)}};window.google?b():m.getScript("//www.google.com/jsapi",function(){google.load("feeds","1",{callback:function(){b()}})});var e=document.createElement("div"),h=document.getElementById(d.target),f=function(){if(k)d.feed=new GFdynamicFeedControl(d.url,e,{vertical:d.orientation.toLowerCase()==="vertical"?true:false,horizontal:d.orientation.toLowerCase()==="horizontal"?
true:false,title:d.title=d.title||"Blog"});else setTimeout(function(){f()},5)};if(!d.orientation||d.orientation.toLowerCase()!=="vertical"&&d.orientation.toLowerCase()!=="horizontal")d.orientation="vertical";e.style.display="none";e.id="_feed"+i;e.style.width="100%";e.style.height="100%";i++;h&&h.appendChild(e);f();d.toString=function(){return d.url||d._natives.manifest.options.url["default"]};return{start:function(){e.setAttribute("style","display:inline")},end:function(){e.setAttribute("style",
"display:none")},_teardown:function(n){document.getElementById(n.target)&&document.getElementById(n.target).removeChild(e);delete n.feed}}},{about:{name:"Popcorn Google Feed Plugin",version:"0.1",author:"David Seifried",website:"dseifried.wordpress.com"},options:{start:{elem:"input",type:"number",label:"Start"},end:{elem:"input",type:"number",label:"End"},target:"feed-container",url:{elem:"input",type:"url",label:"Feed URL","default":"http://planet.mozilla.org/rss20.xml"},title:{elem:"input",type:"text",
label:"Title","default":"Planet Mozilla",optional:true},orientation:{elem:"select",options:["Vertical","Horizontal"],label:"Orientation","default":"Vertical",optional:true}}})})(Popcorn);(function(m){var i=/(?:http:\/\/www\.|http:\/\/|www\.|\.|^)(youtu|vimeo|soundcloud|baseplayer)/,k={},d={vimeo:false,youtube:false,soundcloud:false,module:false};Object.defineProperty(k,void 0,{get:function(){return d[void 0]},set:function(b){d[void 0]=b}});m.plugin("mediaspawner",{manifest:{about:{name:"Popcorn Media Spawner Plugin",version:"0.1",author:"Matthew Schranz, @mjschranz",website:"mschranz.wordpress.com"},options:{source:{elem:"input",type:"text",label:"Media Source","default":"http://www.youtube.com/watch?v=CXDstfD9eJ0"},
caption:{elem:"input",type:"text",label:"Media Caption","default":"Popcorn Popping",optional:true},target:"mediaspawner-container",start:{elem:"input",type:"number",label:"Start"},end:{elem:"input",type:"number",label:"End"},autoplay:{elem:"input",type:"checkbox",label:"Autoplay Video",optional:true},width:{elem:"input",type:"number",label:"Media Width","default":400,units:"px",optional:true},height:{elem:"input",type:"number",label:"Media Height","default":200,units:"px",optional:true}}},_setup:function(b){function e(){function v(){if(n!==
...
function(){v()})}else v()}function h(){window.Popcorn.player?e():setTimeout(function(){h()},300)}var f=document.getElementById(b.target)||{},n,u,q;if(u=i.exec(b.source)){n=u[1];if(n==="youtu")n="youtube"}else n="HTML5";b._type=n;b._container=document.createElement("div");u=b._container;u.id="mediaSpawnerdiv-"+m.guid();b.width=b.width||400;b.height=b.height||200;if(b.caption){q=document.createElement("div");q.innerHTML=b.caption;q.style.display="none";b._capCont=q;u.appendChild(q)}f&&f.appendChild(u);
if(!window.Popcorn.player&&!k.module){k.module=true;m.getScript("http://popcornjs.org/code/modules/player/popcorn.player.js",h)}else h();b.toString=function(){return b.source||b._natives.manifest.options.source["default"]}},start:function(b,e){if(e._capCont)e._capCont.style.display="";e._container.style.width=e.width+"px";e._container.style.height=e.height+"px";e._container.style.visibility="visible";e._container.style.overflow="visible";e.autoplay&&e.popcorn.play()},end:function(b,e){if(e._capCont)e._capCont.style.display=
...
o=d.target,z=i.getElementById(o),J=i.createElement("div"),E=m.position(z),g=d.width||E.width;E=d.height||E.height;var G=d.sidebar||true,A=d.text||true,O=d.pdf||true,a=d.showAnnotations||true,c=d.zoom||700,l=d.search||true;if(!function(j){var s=false;m.forEach(h.viewers,function(t){if(t.api.getSchema().canonicalURL===j){q(t);t=k[d._key];d._containerId=t.id;t.num+=1;s=true;h.loaded=true}});return s}(d.url)){J.id=d._containerId=m.guid(o);o="#"+J.id;z.appendChild(J);f.trigger("documentready");h.load(w,
{width:g,height:E,sidebar:G,text:A,pdf:O,showAnnotations:a,zoom:c,search:l,container:o,afterLoad:d.page||d.aid?function(j){q(j);d._changeView(j);J.style.visibility="hidden";j.elements.pages.hide();v()}:function(j){q(j);v();J.style.visibility="hidden";j.elements.pages.hide()}})}}function e(){window.DV.loaded?b():setTimeout(e,25)}var h=window.DV=window.DV||{},f=this;if(h.loading)e();else{h.loading=true;h.recordHit="//www.documentcloud.org/pixel.gif";var n=i.createElement("link"),u=i.getElementsByTagName("head")[0];
n.rel="stylesheet";n.type="text/css";n.media="screen";n.href="//s3.documentcloud.org/viewer/viewer-datauri.css";u.appendChild(n);h.loaded=false;m.getScript("http://s3.documentcloud.org/viewer/viewer.js",function(){h.loading=false;b()})}d.toString=function(){return d.src||d._natives.manifest.options.src["default"]}},start:function(d,b){var e=i.getElementById(b._containerId),h=DV.viewers[b._key];(b.page||b.aid)&&h&&b._changeView(h);if(e&&h){e.style.visibility="visible";h.elements.pages.show()}},end:function(d,
b){var e=i.getElementById(b._containerId);if(e&&DV.viewers[b._key]){e.style.visibility="hidden";DV.viewers[b._key].elements.pages.hide()}},_teardown:function(d){var b=i.getElementById(d._containerId);if((d=d._key)&&DV.viewers[d]&&--k[d].num===0){for(DV.viewers[d].api.unload();b.hasChildNodes();)b.removeChild(b.lastChild);b.parentNode.removeChild(b)}}})})(Popcorn,window.document);document.addEventListener("click",function(m){m=m.target;if(m.nodeName==="A"||m.parentNode&&m.parentNode.nodeName==="A")Popcorn.instances.forEach(function(i){i.options.pauseOnLinkClicked&&i.pause()})},false);(function(m){m.parser("parseJSON","JSON",function(i){var k={title:"",remote:"",data:[]};m.forEach(i.data,function(d){k.data.push(d)});return k})})(Popcorn);(function(m){m.parser("parseXML","XML",function(i){var k={title:"",remote:"",data:[]},d={},b=function(q){q=q.split(":");if(q.length===1)return parseFloat(q[0],10);else if(q.length===2)return parseFloat(q[0],10)+parseFloat(q[1]/12,10);else if(q.length===3)return parseInt(q[0]*60,10)+parseFloat(q[1],10)+parseFloat(q[2]/12,10);else if(q.length===4)return parseInt(q[0]*3600,10)+parseInt(q[1]*60,10)+parseFloat(q[2],10)+parseFloat(q[3]/12,10)},e=function(q){for(var v={},w=0,o=q.length;w<o;w++){var z=q.item(w).nodeName,
J=q.item(w).nodeValue,E=d[J];if(z==="in")v.start=b(J);else if(z==="out")v.end=b(J);else if(z==="resourceid")for(var g in E){if(E.hasOwnProperty(g))if(!v[g]&&g!=="id")v[g]=E[g]}else v[z]=J}return v},h=function(q,v){var w={};w[q]=v;return w},f=function(q,v,w){var o={};m.extend(o,v,e(q.attributes),{text:q.textContent||q.text});v=q.childNodes;if(v.length<1||v.length===1&&v[0].nodeType===3)if(w)d[o.id]=o;else k.data.push(h(q.nodeName,o));else for(q=0;q<v.length;q++)v[q].nodeType===1&&f(v[q],o,w)};i=i.documentElement.childNodes;
for(var n=0,u=i.length;n<u;n++)if(i[n].nodeType===1)i[n].nodeName==="manifest"?f(i[n],{},true):f(i[n],{},false);return k})})(Popcorn);(function(m){m.parser("parseTTXT",function(i){var k={title:"",remote:"",data:[]},d=function(n){n=n.split(":");var u=0;try{return parseFloat(n[0],10)*60*60+parseFloat(n[1],10)*60+parseFloat(n[2],10)}catch(q){u=0}return u},b=function(n,u){var q={};q[n]=u;return q};i=i.xml.lastChild.lastChild;for(var e=Number.MAX_VALUE,h=[];i;){if(i.nodeType===1&&i.nodeName==="TextSample"){var f={};f.start=d(i.getAttribute("sampleTime"));f.text=i.getAttribute("text");if(f.text){f.end=e-0.001;h.push(b("subtitle",f))}e=
f.start}i=i.previousSibling}k.data=h.reverse();return k})})(Popcorn);(function(m){function i(d,b){var e={};e[d]=b;return e}function k(d){d=d.split(":");try{var b=d[2].split(",");if(b.length===1)b=d[2].split(".");return parseFloat(d[0],10)*3600+parseFloat(d[1],10)*60+parseFloat(b[0],10)+parseFloat(b[1],10)/1E3}catch(e){return 0}}m.parser("parseSRT",function(d,b){var e={title:"",remote:"",data:[]},h=[],f=0,n=0,u,q,v,w,o;u=d.text.split(/(?:\r\n|\r|\n)/gm);for(v=u.length-1;v>=0&&!u[v];)v--;w=v+1;for(f=0;f<w;f++){o={};v=[];for(f=f;!u[f];)f++;f=f;o.id=parseInt(u[f++],10);
q=u[f++].split(/[\t ]*--\>[\t ]*/);o.start=k(q[0]);n=q[1].indexOf(" ");if(n!==-1)q[1]=q[1].substr(0,n);for(o.end=k(q[1]);f<w&&u[f];)v.push(u[f++]);o.text=v.join("\\N").replace(/\{(\\[\w]+\(?([\w\d]+,?)+\)?)+\}/gi,"");o.text=o.text.replace(/</g,"&lt;").replace(/>/g,"&gt;");o.text=o.text.replace(/&lt;(\/?(font|b|u|i|s))((\s+(\w|\w[\w\-]*\w)(\s*=\s*(?:\".*?\"|'.*?'|[^'\">\s]+))?)+\s*|\s*)(\/?)&gt;/gi,"<$1$3$7>");o.text=o.text.replace(/\\N/gi,"<br />");if(b&&b.target)o.target=b.target;h.push(i("subtitle",
o))}e.data=h;return e})})(Popcorn);(function(m){function i(f,n,u){var q=f.firstChild;f=k(f,u);u=[];for(var v;q;){if(q.nodeType===1)if(q.nodeName==="p")u.push(d(q,n,f));else if(q.nodeName==="div"){v=b(q.getAttribute("begin"));if(v<0)v=n;u.push.apply(u,i(q,v,f))}q=q.nextSibling}return u}function k(f,n){var u=f.getAttribute("region");return u!==null?u:n||""}function d(f,n,u){var q={};q.text=(f.textContent||f.text).replace(e,"").replace(h,"<br />");q.id=f.getAttribute("xml:id")||f.getAttribute("id");q.start=b(f.getAttribute("begin"),n);
q.end=b(f.getAttribute("end"),n);q.target=k(f,u);if(q.end<0){q.end=b(f.getAttribute("duration"),0);if(q.end>=0)q.end+=q.start;else q.end=Number.MAX_VALUE}return{subtitle:q}}function b(f,n){var u;if(!f)return-1;try{return m.util.toSeconds(f)}catch(q){for(var v=f.length-1;v>=0&&f[v]<="9"&&f[v]>="0";)v--;u=v;v=parseFloat(f.substring(0,u));u=f.substring(u);return v*({h:3600,m:60,s:1,ms:0.001}[u]||-1)+(n||0)}}var e=/^[\s]+|[\s]+$/gm,h=/(?:\r\n|\r|\n)/gm;m.parser("parseTTML",function(f){var n={title:"",
remote:"",data:[]};if(!f.xml||!f.xml.documentElement)return n;f=f.xml.documentElement.firstChild;if(!f)return n;for(;f.nodeName!=="body";)f=f.nextSibling;if(f)n.data=i(f,0);return n})})(Popcorn);(function(m){function i(d){var b=d.split(":");d=d.length;var e;if(d!==12&&d!==9)throw"Bad cue";d=b.length-1;try{e=parseInt(b[d-1],10)*60+parseFloat(b[d],10);if(d===2)e+=parseInt(b[0],10)*3600}catch(h){throw"Bad cue";}return e}function k(d,b){var e={};e[d]=b;return e}m.parser("parseVTT",function(d){var b={title:"",remote:"",data:[]},e=[],h=0,f=0,n,u;d=d.text.split(/(?:\r\n|\r|\n)/gm);f=d.length;if(f===0||d[0]!=="WEBVTT")return b;for(h++;h<f;){n=[];try{for(var q=h;q<f&&!d[q];)q++;h=q;var v=d[h++];q=
void 0;var w={};if(!v||v.indexOf("--\>")===-1)throw"Bad cue";q=v.replace(/--\>/," --\> ").split(/[\t ]+/);if(q.length<2)throw"Bad cue";w.id=v;w.start=i(q[0]);w.end=i(q[2]);for(u=w;h<f&&d[h];)n.push(d[h++]);u.text=n.join("<br />");e.push(k("subtitle",u))}catch(o){for(h=h;h<f&&d[h];)h++;h=h}}b.data=e;return b})})(Popcorn);(function(m){function i(b,e){var h=b.substr(10).split(","),f;f={start:k(h[e.start]),end:k(h[e.end])};if(f.start===-1||f.end===-1)throw"Invalid time";var n=w.call(q,/\{(\\[\w]+\(?([\w\d]+,?)+\)?)+\}/gi,""),u=n.replace,q;q=h.length;w=[];for(var v=e.text;v<q;v++)w.push(h[v]);q=w.join(",");var w=q.replace;f.text=u.call(n,/\\N/gi,"<br />");return f}function k(b){var e=b.split(":");if(b.length!==10||e.length<3)return-1;return parseInt(e[0],10)*3600+parseInt(e[1],10)*60+parseFloat(e[2],10)}function d(b,
e){var h={};h[b]=e;return h}m.parser("parseSSA",function(b){var e={title:"",remote:"",data:[]},h=[],f=0,n;b=b.text.split(/(?:\r\n|\r|\n)/gm);for(n=b.length;f<n&&b[f]!=="[Events]";)f++;var u=b[++f].substr(8).split(", "),q={},v,w;w=0;for(v=u.length;w<v;w++)if(u[w]==="Start")q.start=w;else if(u[w]==="End")q.end=w;else if(u[w]==="Text")q.text=w;for(;++f<n&&b[f]&&b[f][0]!=="[";)try{h.push(d("subtitle",i(b[f],q)))}catch(o){}e.data=h;return e})})(Popcorn);(function(m){m.parser("parseSBV",function(i){var k={title:"",remote:"",data:[]},d=[],b=0,e=0,h=function(w){w=w.split(":");var o=w.length-1,z;try{z=parseInt(w[o-1],10)*60+parseFloat(w[o],10);if(o===2)z+=parseInt(w[0],10)*3600}catch(J){throw"Bad cue";}return z},f=function(w,o){var z={};z[w]=o;return z};i=i.text.split(/(?:\r\n|\r|\n)/gm);for(e=i.length;b<e;){var n={},u=[],q=i[b++].split(",");try{n.start=h(q[0]);for(n.end=h(q[1]);b<e&&i[b];)u.push(i[b++]);n.text=u.join("<br />");d.push(f("subtitle",n))}catch(v){for(;b<
e&&i[b];)b++}for(;b<e&&!i[b];)b++}k.data=d;return k})})(Popcorn);(function(m,i){var k=function(d,b){return typeof b==="string"&&i.HTMLYouTubeVideoElement._canPlaySrc(b)};i.player("youtube",{_canPlayType:k});i.youtube=function(d,b,e){typeof console!=="undefined"&&console.warn&&console.warn("Deprecated player 'youtube'. Please use Popcorn.HTMLYouTubeVideoElement directly.");var h=i.HTMLYouTubeVideoElement(d);d=i(h,e);setTimeout(function(){h.src=b},0);return d};i.youtube.canPlayType=k})(window,Popcorn);(function(m,i){i.player("soundcloud",{_canPlayType:function(k,d){return typeof d==="string"&&i.HTMLSoundCloudAudioElement._canPlaySrc(d)&&k.toLowerCase()!=="audio"}});i.soundcloud=function(k,d,b){typeof console!=="undefined"&&console.warn&&console.warn("Deprecated player 'soundcloud'. Please use Popcorn.HTMLSoundCloudAudioElement directly.");var e=i.HTMLSoundCloudAudioElement(k);k=i(e,b);setTimeout(function(){e.src=d},0);return k}})(window,Popcorn);(function(m,i){i.player("vimeo",{_canPlayType:function(k,d){return typeof d==="string"&&i.HTMLVimeoVideoElement._canPlaySrc(d)}});i.vimeo=function(k,d,b){typeof console!=="undefined"&&console.warn&&console.warn("Deprecated player 'vimeo'. Please use Popcorn.HTMLVimeoVideoElement directly.");var e=i.HTMLVimeoVideoElement(k);k=i(e,b);setTimeout(function(){e.src=d},0);return k}})(window,Popcorn);
